...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/album-photo-voyage`,            lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/album-photo-mariage`,           lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/album-photo-naissance`,         lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/avis`,                          lastModified: new Date(), changeFrequency: "monthly", priority: 0.4 },
    { url: `${BASE_URL}/livraison`,                     lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/politique-de-retour`,           lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },
