...
export const metadata: Metadata = {
  ...
  description: "Commande ton album photo imprimé sur papier brillant 170g/m², format A4, couverture rigide. 27 couvertures illustrées. Livré en 7–12 jours en France et Europe.",
