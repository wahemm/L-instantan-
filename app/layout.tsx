...
export const metadata: Metadata = {
  ...
  title: {
    default: "L'Instantané — Album photo premium, livré chez toi",
    template: "%s | L'Instantané",
  },
  ...
  twitter: {
    ...
    title: "L'Instantané — Album photo premium",
    description: "Tes souvenirs méritent un beau livre.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
